...
#define EL_TLOG_TLM_PAGE_SIZE         (4)
#define EL_TLOG_TLM_PAGE_MAX_HIGH     (1)
#define EL_TLOG_TLM_PAGE_MAX_MIDDLE   (1)
#define EL_TLOG_TLM_PAGE_MAX_LOW      (1)
...
#define EL_TLOG_LOG_SIZE_MAX_EL           (4)
#define EL_CLOG_LOG_SIZE_MAX_EL           (8)
#define EL_TLOG_LOG_SIZE_MAX_EH           (4)
