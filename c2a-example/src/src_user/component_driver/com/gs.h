...
/**
 * @struct GS_CcsdsInfo
 * @brief 現在使っている CCSDS API の実行結果
 * @brief 元々 c2a-core/examples/mobc では HAL で定義されていたが、
 * @brief テレメ用構造体は Component Driver で定義されるべきなのでこちらに移動した。
 */
typedef struct
{
