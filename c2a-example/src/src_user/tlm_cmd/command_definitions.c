...
void CA_load_cmd_table(CA_CmdInfo cmd_table[CA_MAX_CMDS])
{
  ...
  cmd_table[Cmd_CODE_UART_REOPEN].cmd_func = Cmd_UART_REOPEN;
  ...
  cmd_table[Cmd_CODE_GPIO_WRITE].cmd_func = Cmd_GPIO_WRITE;
  cmd_table[Cmd_CODE_IFLASH_ERASE].cmd_func = Cmd_IFLASH_ERASE;
  cmd_table[Cmd_CODE_IFLASH_PROGRAM].cmd_func = Cmd_IFLASH_PROGRAM;
  cmd_table[Cmd_CODE_BTMGR_SET_NEXT_BOOT_BANK].cmd_func = Cmd_BTMGR_SET_NEXT_BOOT_BANK;
  cmd_table[Cmd_CODE_BTMGR_SYSTEM_RESET].cmd_func = Cmd_BTMGR_SYSTEM_RESET;
  cmd_table[Cmd_CODE_RAMECC_SET_SCRUBBING_INTERVAL].cmd_func = Cmd_RAMECC_SET_SCRUBBING_INTERVAL;
  cmd_table[Cmd_CODE_APP_TMD_MEM_DUMP].cmd_func = Cmd_APP_TMD_MEM_DUMP;
  ...
  cmd_table[Cmd_CODE_UART_REOPEN].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_UART_REOPEN].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_4BYTE;
  cmd_table[Cmd_CODE_UART_TEST_SEND_TEST].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_GPIO_WRITE].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_GPIO_WRITE].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_IFLASH_PROGRAM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_4BYTE;
  cmd_table[Cmd_CODE_IFLASH_PROGRAM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_RAW;
  cmd_table[Cmd_CODE_BTMGR_SET_NEXT_BOOT_BANK].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_4BYTE;
  cmd_table[Cmd_CODE_RAMECC_SET_SCRUBBING_INTERVAL].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_4BYTE;
  cmd_table[Cmd_CODE_APP_TMD_MEM_DUMP].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_4BYTE;
  cmd_table[Cmd_CODE_APP_TMD_MEM_DUMP].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_4BYTE;
